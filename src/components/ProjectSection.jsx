  ...
  const projectsData = [
    {
      ...
      description:
        "A landmark commercial space designed with innovation and strength, featuring state-of-the-art facilities and sustainable design principles.",
      type: "Commercial",
    ...
    },
    {
      ...
      tag: "New Launch",
      description:
        "Premium residential towers offering luxury living with panoramic city views and world-class amenities.",
      type: "Residential",
      image: `${__IMAGE_BASE_PATH__}/project1.png`,
    },
    {
      ...
      tag: "Award Winning",
      description:
        "An integrated township with residential, commercial, and recreational spaces designed for modern living.",
      type: "Mixed Use",
      image: `${__IMAGE_BASE_PATH__}/project1.png`,
    },
    {
      ...
      tag: "Coming Soon",
      description:
        "A futuristic IT park with smart office solutions and collaborative workspaces for tech companies.",
      type: "Commercial",
      image: `${__IMAGE_BASE_PATH__}/project1.png`,
    },
    {
      ...
      tag: "Eco Project",
      description:
        "Sustainable residential community with green spaces, solar power, and water conservation systems.",
      type: "Residential",
      image: `${__IMAGE_BASE_PATH__}/project1.png`,
    },
    {
      ...
      description:
        "Modern industrial complex with advanced infrastructure for manufacturing and logistics.",
      type: "Industrial",
      image: `${__IMAGE_BASE_PATH__}/project1.png`,
    },
  ];
    ...
    <div className="bg-[#3366BB] w-full overflow-hidden relative py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="flex items-center justify-center gap-2 text-lg md:text-2xl text-orange-500 font-semibold mb-3">
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div
                  ...
                  } group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6`}
                >
                  <div
                    className={`${
