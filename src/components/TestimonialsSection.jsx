    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <h2 className="text-lg md:text-2xl text-orange-500 font-semibold mb-3 flex items-center justify-center space-x-3">
            <ArrowLeft className="w-5 h-5 text-orange-500" /> {/* ✅ replaced */}
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <div className="flex justify-center space-x-4 md:hidden">
            ...
            >
              <ArrowLeft className="w-5 h-5" /> {/* ✅ replaced */}
            </button>
            <button
              onClick={nextTestimonial}
              className="w-10 h-10 rounded-full bg-orange-500 flex items-center justify-center text-white hover:bg-orange-600 transition shadow-md"
            >
              <ArrowRight className="w-5 h-5" /> {/* ✅ replaced */}
            </button>
          </div>
