    ...
    <div className="bg-white min-h-screen font-sans flex flex-col">
      ...
      <div className="relative h-72 w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end items-center h-full pb-8">
          ...
          <motion.h1
            className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4 leading-tight text-center"
          ...
          <motion.div
            className="w-140 h-2 bg-gradient-to-r from-orange-600 to-orange-400 rounded-full mb-4"
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
